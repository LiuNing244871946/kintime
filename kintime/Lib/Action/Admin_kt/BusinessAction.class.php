...
class BusinessAction extends CommonAction {
    ...
    private $create_fields = array('business_name','lao_business_name','eng_business_name', 'orderby');
    private $edit_fields = array('business_name','lao_business_name','eng_business_name', 'orderby');
    private $area_id = '';
    ...
    public function index() {
        ...
        if($keyword){
           $map['business_name|lao_business_name|eng_business_name'] = array('LIKE', '%'.$keyword.'%');
       }   
    ...
    private function createCheck() {
        ...
        if (empty($data['business_name'])) {
            $this->baoError('中文商圈名称不能为空');
        } 
        $data['lao_business_name'] = htmlspecialchars($data['lao_business_name']);
        if (empty($data['lao_business_name'])) {
            $this->baoError('老文商圈名称不能为空');
        }
        $data['eng_business_name'] = htmlspecialchars($data['eng_business_name']);
        if (empty($data['eng_business_name'])) {
            $this->baoError('英文商圈名称不能为空');
        }
