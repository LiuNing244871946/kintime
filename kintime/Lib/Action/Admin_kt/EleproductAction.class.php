...
class EleproductAction extends CommonAction {
    ...
    private $create_fields = array('product_name' ,'lao_product_name','eng_product_name','shop_id', 'cate_id', 'photo', 'price', 'is_new', 'is_hot', 'is_tuijian', 'sold_num', 'month_num', 'create_time', 'create_ip');
    private $edit_fields = array('product_name' ,'lao_product_name','eng_product_name','shop_id', 'cate_id', 'photo', 'price', 'is_new', 'is_hot', 'is_tuijian', 'sold_num', 'month_num');
    ...
    public function edit($product_id = 0) {
        if ($product_id = (int) $product_id) {
            ...
            if ($this->isPost()) {
                ...
                $this->assign('cates', D('Elecate')->where('shop_id='.$detail['shop_id'])->select());
    ...
    public function cate(){
        ...
        $shop_id = (int) $shop_id;
        $cates = D('Elecate')->where('shop_id='.$shop_id)->select();
