...
class TuancateAction extends CommonAction {
    ...
    private $create_fields = array('cate_name','lao_cate_name','eng_cate_name','rate', 'orderby');
    private $edit_fields = array('cate_name','lao_cate_name','eng_cate_name','rate', 'orderby');
    ...
    public function select(){
        ...
        if($cate_name = $this->_param('cate_name','htmlspecialchars')){
            $map['cate_name|lao_cate_name|eng_cate_name'] = array('LIKE','%'.$cate_name.'%');
