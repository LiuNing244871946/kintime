...
class UseraddrAction extends CommonAction {
    ...
    private $create_fields = array('user_id','city_id', 'area_id', 'business_id', 'name', 'areacode','mobile', 'addr','lat','lng');
    private $edit_fields = array('user_id','city_id', 'area_id', 'business_id', 'name', 'areacode','mobile', 'addr','lat','lng');
