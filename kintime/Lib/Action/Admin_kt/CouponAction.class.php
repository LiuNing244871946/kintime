...
class CouponAction extends CommonAction {
    ...
    private $create_fields = array('shop_id', 'title','lao_title','eng_title', 'photo', 'expire_date','num','limit_num', 'intro', 'lao_intro', 'eng_intro');
    private $edit_fields = array('shop_id', 'title','lao_title','eng_title', 'photo', 'expire_date','num','limit_num', 'intro');
