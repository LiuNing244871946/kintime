...
class CityAction extends CommonAction {
    ...
    private $create_fields = array('name', 'lao_name', 'eng_name', 'pinyin', 'is_open', 'lng', 'lat','orderby','theme','first_letter');
    private $edit_fields = array('name', 'lao_name', 'eng_name', 'pinyin', 'is_open', 'lng', 'lat','orderby','theme','first_letter');
    ...
    public function index() {
        ...
        if($keyword){
            $map['name|pinyin|lao_name|eng_name'] = array('LIKE', '%'.$keyword.'%');
        }    
