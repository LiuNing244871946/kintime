...
class PublicAction extends CommonAction {
    ...
    //升级之前需要请求kintime看看是否是授权用户，kintime会进行回调验证TOKEN授权的
    public function token(){
        $url = 'http://www.kintime.la/update/token.html?host='.urlencode($_SERVER['HTTP_HOST']).'&bao_key='.C('BAO_KEY');
