...
class ArticleAction extends CommonAction {
    ...
    private $create_fields = array('cate_id' ,'city_id' ,'title', 'source', 'keywords', 'desc', 'photo', 'details', 'create_time', 'create_ip', 'views');
    private $edit_fields = array('cate_id' ,'city_id' ,'title', 'source', 'keywords', 'desc', 'photo', 'details', 'views');
    ...
    private function createCheck() {
        ...
        $data['city_id'] = htmlspecialchars($data['city_id']);
